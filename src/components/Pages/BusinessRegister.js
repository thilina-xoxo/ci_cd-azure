...
const CreateProfile =() => {
  ...
  <h1 className='text-2xl xl:text-2xl font-extrabold text-orange-500 text-center '>
           ...
           <form className="mb-6 mx-3">
           <p className="text-red-500 text-xs italic mb-2">**Please fill out all the fields.</p>
...
>
    ...
    <div className="w-full ">
      <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="bname">
     Business Name
      </label>
  ...
  <div className="flex flex-wrap -mx-3 mb-6">
    <div className="w-full">
      <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="grid-currentCrowd">
     Current Crowd
      </label>
      <input className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" 
  ...
  <div className="flex flex-wrap -mx-3 mb-6">
    <div className="w-full">
      <label className="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" htmlFor="grid-summary">
      Summary
      </label>
      ...
      <p className="text-gray-600 text-xs italic">Make it more simpler</p>
    </div>
  </div>
