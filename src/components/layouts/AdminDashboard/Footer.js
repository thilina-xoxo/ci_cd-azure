    ...
    <div className='footer bottom-auto' className='Footer'>
        ...
        <div className='flex flex-wrap mb-4 w-full'>
          ...
          <div className='w-full sm:w-1/2 md:w-1/2 lg:w-1/4'>
            ...
            <form action='#'>
              <div className='mb-4'>
                <input
                  className='bg-gray-200  text-xs appearance-none border-2 border-gray-200 rounded w-full py-2 px-2  text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-purple-500'
                  id='inline-full-name'
                  type='text'
                  placeholder='Email'
                />
              ...
              <button
                className='bg-pink-600 hover:bg-red-800 text-xs text-white font-bold py-2 px-4 rounded'
                type='submit'
              >
                Submit
              </button>
      ...
      <div className='bg-blue-900 p-2 pl-6'>
        <p className='bottom text-xs '>
          ...
          <a href='Hasitha Kumarasinghe' className='text-gray-500'>
            NoQueue
          </a>
        </p>
      </div>
